document.addEventListener("DOMContentLoaded", function () {
  ...
  const items = [
    {name: "冬季大衣", category: "coat", brand: "A", price: 150, image: "https://picsum.photos/300/200?random=1", link: "closet_detail.html?item=coat"},
    {name: "夏季連衣裙", category: "top", brand: "品牌B", price: 100, image: "https://picsum.photos/300/200?random=2", link: "closet_detail.html?item=dress"},
    {name: "牛仔褲", category: "bottom", brand: "品牌C", price: 120, image: "https://picsum.photos/300/200?random=3", link: "closet_detail.html?item=jeans"},
    {name: "針織衫", category: "top", brand: "品牌A", price: 90, image: "https://picsum.photos/300/200?random=4", link: "closet_detail.html?item=sweater"},
    {name: "運動鞋", category: "shoes", brand: "品牌B", price: 80, image: "https://picsum.photos/300/200?random=5", link: "closet_detail.html?item=shoes"},
    ...
    {name: "短褲", category: "bottom", brand: "品牌A", price: 70, image: "https://picsum.photos/300/200?random=10", link: "closet_detail.html?item=shorts"},
    {name: "西裝外套", category: "coat", brand: "品牌D", price: 220, image: "https://picsum.photos/300/200?random=11", link: "closet_detail.html?item=suit"},
